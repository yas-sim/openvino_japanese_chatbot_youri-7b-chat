...
# INT8
# - INT8 model conversion/quantization requires huge memory to complete.
#   I could succeed to convert the model on a Xeon system with 256GB of memory
#   but failed on a desktop PC with 64GB of main memory.
